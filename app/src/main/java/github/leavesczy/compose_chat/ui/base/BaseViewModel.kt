...
import github.leavesczy.compose_chat.ui.widgets.LoadingDialogViewState
...
abstract class BaseViewModel : ViewModel() {
    ...
    protected fun showLoadingDialog(cancelable: Boolean = false) {
        loadingDialogViewState.show(cancelable = cancelable)
    }
